            ...
            <form id='CadastroCarro'>
                <div className="space-y-12">
                    <div className="border-b border-gray-900/10 pb-12">
                        <h2 className="text-base font-semibold leading-7 text-gray-900">Cadastre seu veículo</h2>
                        <div className="sm:col-span-4">
                            ...
                            <p>Não possui uma conta? <Link href="#cadastre-se" className="text-indigo-600">Cadastre-se</Link></p>
                        </div>
